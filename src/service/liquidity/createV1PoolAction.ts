...
export const createV1PoolAction = async (lucid: Lucid, emulator?: Emulator, proxyDatum?: string) => {
    ...
    const datums: { [key: string]: string } = {
        "d2653ed85dac06c5b39554b78875d4f8cb6680a274a0f2cf6897f2b99e35b0da": "d8799f4121d8798041009f581cbb0d2cc0d7f7b80d3c0d7a7ac441f3865ffd297613c67f06951eb7faffff",
    }
    ...
    const unsignedTx = await createLiquidityV1Pool(lucid, {
        ...
        projectToken: {
            assetName: Buffer.from(process.env.PROJECT_TN!).toString("hex"),
            policyId: process.env.PROJECT_CS!,
            totalSupply: BigInt(process.env.PROJECT_AMNT!)
        },
        v1PoolFactoryToken: {
            policyId: (process.env.V1_POOL_FACTORY_TOKEN!).split(".")[0],
            assetName: (process.env.V1_POOL_FACTORY_TOKEN!).split(".")[1]
        },
        datums,
        v1PoolScriptAddress: process.env.V1_POOL_SCRIPT_ADDRESS!
    })
